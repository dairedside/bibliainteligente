...
export const BIBLE_BOOKS = [
  ...
  'Jó', 'Salmos', 'Provérbios', 'Eclesiastes', 'Cantares de Salomão', 'Isaías', 'Jeremias', 
...
export const THEOLOGY_TOPICS = ['Graça', 'Salvação', 'Reino de Deus', 'Trindade', 'Soberania', 'Aliança'];
